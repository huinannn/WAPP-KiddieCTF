<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignmentProgress.aspx.cs" Inherits="WAPP_KiddieCTF.Lecturer.AssignmentProgress" %>
...
<head runat="server">
    ...
    <!-- Assignment Progress Page CSS -->
    <link href="css/assignmentProgress.css" rel="stylesheet" runat="server" />
                ...
                <asp:UpdatePanel ID="UpdatePanelSearch" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div class="search-box">
                            ...
                            <label class="placeholder-label">Search Student ID/StudentName</label>
                        </div>
                    </ContentTemplate>
                    <Triggers>
                ...
                <ContentTemplate>
                    <div class="content-panel">
                        <div class="table-header">
                            ...
                            <div class="col-status">Final Assignment Progress</div>
                                ...
                                <ItemTemplate>
                                    <div class="table-row">
                                        ...
                                        <div class="col-action">
                                            <asp:HyperLink ID="lnkReview" runat="server"
